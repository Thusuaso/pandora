<template>
  <div>
      ...
      <div class="container">
        ...
        <div class="features-grid">
          ...
          <div class="feature-card">
            ...
            <p>%100 bitkisel, çocuk ve evcil hayvan dostu şampuanlarla yıkama.</p>
          </div>
          <div class="feature-card">
            <span class="feature-icon">⚡</span>
    ...
    <section class="bolge-section">
      <div class="container">
        <h2>Pamukkale'de Hizmet Verdiğimiz Mahalleler</h2>
        <p>Aşağıdaki mahallelerin tamamına ücretsiz servis sağlıyoruz:</p>
        <div class="bolge-grid">
          <span>Kayabaşı</span>
          <span>Aktepe</span>
          <span>Bereketli</span>
          <span>Çamlaraltı</span>
          <span>Dokuzkavaklar</span>
          <span>Fatih</span>
          <span>Fesleğen</span>
          <span>Güzelköy</span>
