<template>
  <section class="py-12 bg-[#0B0F19] border-t border-slate-800">
    <div class="container mx-auto px-4">
      <h3
        class="text-slate-500 text-sm font-bold uppercase tracking-widest mb-6 text-center"
      >
        Denizli Hizmet Ağımız
      </h3>
